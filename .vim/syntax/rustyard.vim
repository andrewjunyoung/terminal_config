...
if &background == "dark"
  ...
  SynColor Identifier	term=underline cterm=bold ctermfg=LightGreen ctermbg=NONE gui=NONE guifg=#40ffff guibg=NONE
  SynColor Statement	term=bold cterm=NONE ctermfg=LightGreen ctermbg=NONE gui=bold guifg=#ffff60 guibg=NONE
